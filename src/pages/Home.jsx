...
const Home = () => {
  ...
  return (
    <section className="h-screen bg-black flex items-center justify-center">
      ...
      <div className="mt-110 md:mt-100 lg:mt-20  flex absolute flex-col xl:gap-15 lg:flex-row items-center gap-10 text-center lg:text-left bg-opacity-50 p-10 rounded-lg">
